...
[Files]
Source: "C:/GitBash/Git/calc_app/func.py"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:/GitBash/Git/calc_app/test.py"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:/GitBash/Git/calc_app/ui.py"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:/GitBash/Git/calc_app/dist/$projname.exe"; DestDir: "{app}"; Flags: ignoreversion
EOF
